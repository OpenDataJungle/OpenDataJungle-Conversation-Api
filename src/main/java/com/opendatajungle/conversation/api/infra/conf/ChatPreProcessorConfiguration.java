...
public class ChatPreProcessorConfiguration {
    @Bean
    @ConditionalOnProperty(name = "open-data-jungle.chat.pre-processors.default-system-prompt.enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(name = "open-data-jungle.chat.pre-processors.resource-categorization.enabled", havingValue = "true", matchIfMissing = true)
    ...
    @Bean
    @ConditionalOnProperty(name = "open-data-jungle.chat.pre-processors.basic-resource-manager.enabled", havingValue = "true", matchIfMissing = true)
